        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DiscountCategoryId = table.Column<Guid>(type: "uniqueidentifier", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_DiscountCode", x => x.Id);
                    table.ForeignKey(
                        name: "FK_DiscountCode_Cart_CustomerId",
                        column: x => x.CustomerId,
                        principalTable: "Cart",
                        principalColumn: "CustomerId");
                    table.ForeignKey(
                        name: "FK_DiscountCode_DiscountCategory_DiscountCategoryId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DiscountCode_DiscountCategoryId",
                table: "DiscountCode",
